...
- options: {coreID: m4}
- pin_list:
  - {pin_num: A6, peripheral: UART3, signal: uart_rx, pin_signal: UART3_RXD, PUE: Enabled, SRE: MEDIUM, DSE: OHM_45}
  - {pin_num: B7, peripheral: UART3, signal: uart_tx, pin_signal: UART3_TXD, PUE: Enabled, SRE: MEDIUM, DSE: OHM_45}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
- options: {coreID: m4}
- pin_list:
  - {pin_num: A6, peripheral: GPIO5, signal: 'gpio_io, 26', pin_signal: UART3_RXD}
  - {pin_num: B7, peripheral: GPIO5, signal: 'gpio_io, 27', pin_signal: UART3_TXD}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
